<%-- 
    Document   : enquiry
    Created on : Feb 18, 2012, 1:00:31 PM
    Author     : santosh
--%>
...
function googleTranslateElementInit() {
  new google.translate.TranslateElement({
    ...
    <form action="enqui.jsp" method="post">
        <h2 align="center"> Enter the PNR for your booking below to get the current status. You will find it on the top left corner of the ticket. </h2>
        
        <div align="center"> <h2>PNR:<input type="text" name="txtenq" value=""/></h2></div>
        <div align="center"><input type="submit" value="Enquiry"/>
